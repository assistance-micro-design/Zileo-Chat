...
export const settings = derived(validationSettingsStore, ($store) => $store.settings);

/** Derived store for loading state */
export const isLoading = derived(validationSettingsStore, ($store) => $store.loading);

/** Derived store for saving state */
export const isSaving = derived(validationSettingsStore, ($store) => $store.saving);

/** Derived store for error state */
export const settingsError = derived(validationSettingsStore, ($store) => $store.error);

/** Derived store to check if settings are loaded */
export const hasSettings = derived(validationSettingsStore, ($store) => $store.settings !== null);
