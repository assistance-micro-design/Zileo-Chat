...
| [AGENT_TOOLS_DOCUMENTATION.md](AGENT_TOOLS_DOCUMENTATION.md) | Standard agent tools (Todo, Memory, Calculator, UserQuestion, FileManager incl. `read_image` for multimodal vision, Spawn/Delegate/Parallel sub-agents, ReadSkill) plus the Kanban supervisor toolkit (PromptManager, SkillManager, WorkflowManager, ListAgents, SubmitComposedCard, SubmitAnalysis) |
