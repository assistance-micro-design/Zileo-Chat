...
| SA-015 | [Dead Code Cleanup](./SA-015-dead-code-cleanup.md) | 2026-02-21 | Quality audit | **Phases 1-2 DONE**: Phase 1: annotation cleanup. Phase 2: 5 superseded methods deleted, 6 tests migrated, 4 tests deleted. Phases 3-5 pending. |
