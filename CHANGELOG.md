...
- **Speech-to-text now defaults to `voxtral-small-latest`** (`src-tauri/src/models/stt.rs`, `src/types/stt.ts`) -- the dictation model id ships with a sensible default instead of being empty on first launch.
